<ul class="navbar-nav bg-gradient-company sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('company.index') }}">
    ...
    <li class="nav-item active">
        <a class="nav-link" href="{{ route('company.index') }}"> <i class="fas fa-fw fa-tachometer-alt"></i> <span>Início</span></a>
    </li>
